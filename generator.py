...
def RawSuppliers(_range):
    ...
    for i in range(1, _range):
        ...
        RawMaterialQuantity = 100 * math.floor(random.randint(100, 10000)/100)
        RawMaterialUnitPrice = 100 * math.floor(random.randint(100, 5000)/100)
...
def PricingPerMadeMaterial(_range):
    ...
    for i in range(1, _range):
        ...
        TotalCost = 100 * math.floor(random.randint(100, 10000)/100)
